...
public class IngestFeatures implements FeatureSpecification {
    ...
    public static final NodeFeature DYNAMIC_STRINGS_AUTO_KEYWORD_SETTING = new NodeFeature("ingest.dynamic_strings.auto_keyword_setting");
    ...
    public Set<NodeFeature> getTestFeatures() {
        return Set.of(
            ...
            DYNAMIC_STRINGS_AUTO_KEYWORD_SETTING
        );
    }
}
